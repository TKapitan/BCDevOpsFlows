...
| <a id="customCodeCops"></a>customCodeCops | CustomCodeCops is an array of paths or URLs to custom Code Cop DLLs you want to enable when building. Do not add LinterCop as custom code cop, use **enableLinterCop** settings instead. | [ ] |
