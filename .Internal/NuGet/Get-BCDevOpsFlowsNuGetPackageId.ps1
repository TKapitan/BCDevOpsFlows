...
<# 
 ...
 .PARAMETER version
  App Version
 .EXAMPLE
  Get-BCDevOpsFlowsNuGetPackageId -publisher 'Freddy Kristiansen' -name 'Bing Maps PTE' -id '165d73c1-39a4-4fb6-85a5-925edc1684fb'
#>
function Get-BCDevOpsFlowsNuGetPackageId {
    Param(
...
Export-ModuleMember -Function Get-BCDevOpsFlowsNuGetPackageId